...
// ΑΣΦΑΛΗΣ & ΟΜΑΛΗ ΡΟΗ ΦΟΡΤΩΣΗΣ (BULLETPROOF FETCH)
async function fetchMarketData() {
    ...
    const texts = {
        en: [
            ...
            { p: 30, t: `Loading Market Data (${tEn.tabOverview})` },
            { p: 45, t: `Loading Market Data (${tEn.tabEconomics})` },
            { p: 60, t: `Loading Market Data (${tEn.tabIspScada})` },
            { p: 75, t: `Loading Market Data (${tEn.tabSurplus})` },
            { p: 88, t: "Processing and normalizing datasets..." }
        ],
        el: [
            { p: 15, t: "Αρχικοποίηση Dashboard..." },
            { p: 30, t: `Φόρτωση Δεδομένων (${tEl.tabOverview})` },
            { p: 45, t: `Φόρτωση Δεδομένων (${tEl.tabEconomics})` },
            { p: 60, t: `Φόρτωση Δεδομένων (${tEl.tabIspScada})` },
            { p: 75, t: `Φόρτωση Δεδομένων (${tEl.tabSurplus})` },
